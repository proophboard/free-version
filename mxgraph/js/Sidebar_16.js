	...
	if (this.enableTooltips && this.showTooltips)
	{
		if (this.currentElt != elt)
		{
			...
			var show = mxUtils.bind(this, function()
			{
				...
				if(firstCell) {
					if(inspectioUtils.isContainer(firstCell)) {
...
Sidebar.prototype.addGeneralPalette = function(expand)
{
	...
	var fns = [
        ...
        this.createVertexTemplateEntry(ispConst.TYPE_AGGREGATE, rect.width, rect.height, this.createVertexXmlValue(ispConst.TYPE_AGGREGATE, ''), 'Aggregate', null, null, 'aggregate entity', undefined, undefined, thumbStyle(ispConst.TYPE_AGGREGATE_THUMB)),
        ...
        this.createVertexTemplateEntry(ispConst.TYPE_POLICY, square.width, square.height, this.createVertexXmlValue(ispConst.TYPE_POLICY, ''), 'Policy', null, null, 'policy process manager', undefined, undefined, thumbStyle(ispConst.TYPE_POLICY_THUMB)),
        ...
        this.createVertexTemplateEntry(ispConst.TYPE_BC, 800, 600, this.createVertexXmlValue(ispConst.TYPE_BC, ''), 'Bounded Context', null, null, ispConst.TYPE_BC, mxUtils.bind(this, this.initContainer), ispConst.TYPE_BC, thumbStyle(ispConst.TYPE_BC_THUMB)),
		...
		this.createVertexTemplateEntry(ispConst.TYPE_IMAGE, square.width, square.height, this.createVertexXmlValue(ispConst.TYPE_IMAGE, ''), 'Image', null, null, 'UI', undefined, undefined, thumbStyle(ispConst.TYPE_IMAGE_THUMB), insertImageHook),
...
Sidebar.prototype.initContainer = function (container)
{
	...
	const orgStyle = this.editorUi.editor.graph.getStylesheet().getCellStyle(container.getStyle());
    ...
    this.graph.orderCells(true, [container]);
}
 ...
 * Creates a drop handler for inserting the given cells.
 */
Sidebar.prototype.createVertexTemplateEntry = function(style, width, height, value, title, showLabel, showTitle, tags, onBeforeInsertVertex, cellType, thumbStyle, onAfterInsert)
{
	tags = (tags != null && tags.length > 0) ? tags : title.toLowerCase();

	return this.addEntry(tags, mxUtils.bind(this, function()
 	{
 		return this.createVertexTemplate(style, width, height, value, title, showLabel, showTitle, null, onBeforeInsertVertex, cellType, thumbStyle, onAfterInsert);
 	}));
}
 ...
 * Creates a drop handler for inserting the given cells.
 */
Sidebar.prototype.createVertexTemplate = function(style, width, height, value, title, showLabel, showTitle, allowCellsInserted, onBeforeInsertVertex, cellType, thumbStyle, onAfterInsert)
{
