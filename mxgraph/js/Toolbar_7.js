...
Toolbar.prototype.createTextToolbar = function()
{
	...
	var formatMenu = this.addMenuFunction('', mxResources.get('format'), false, mxUtils.bind(this, function(menu)
	{
        ...
        elt.innerHTML = '<div class="gePopupIcon"><i class="subscript icon" /></div>'
        ...
        elt.innerHTML = '<div class="gePopupIcon"><i class="superscript icon" /></div>'

		// KNOWN: IE+FF don't return keyboard focus after color dialog (calling focus doesn't help)
		elt = menu.addItem('', null,
			mxUtils.bind(this, function() { ui.menus.pickColor(mxConstants.STYLE_FONTCOLOR, 'forecolor', this.cellFontColor); }),
			null, 'gePopupIcon');
		elt.setAttribute('title', mxResources.get('fontColor'));
        elt.innerHTML = '<div class="gePopupIcon"><i class="font icon" style="color:'+this.cellFontColor+';" /></div>'
		
		elt = menu.addItem('', null,
			mxUtils.bind(this, function() {
				ui.menus.pickColor(mxConstants.STYLE_LABEL_BACKGROUNDCOLOR, ispConst.CMD_PICK_COLOR_CELL_BACKGROUND, this.cellBackgroundColor);
			}),
			null, 'gePopupIcon');
		elt.setAttribute('title', mxResources.get('backgroundColor'));
        elt.innerHTML = '<div class="gePopupIcon"><i class="square full icon" style="color:'+this.cellBackgroundColor+';" /></div>'
	...
	formatMenu.innerHTML = '<i class="list alternate icon" style="margin-left:-2px;"></i>' +
		this.dropdownImageHtml;
	formatMenu.style.width = '50px';
