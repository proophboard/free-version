	...
	if (cmd != null && graph.cellEditor.isContentEditing())
	{
		...
		var dlg = new ColorDialog(this.editorUi, defaultValue || '000000', mxUtils.bind(this, function(color)
		{
			...
			if(cmd === ispConst.CMD_PICK_COLOR_CELL_BACKGROUND) {
				const cellStyle = mxUtils.setStyle(graph.cellEditor.editingCell.getStyle(), mxConstants.STYLE_FILLCOLOR, color);
				graph.model.beginUpdate();
 ...
 */
Menus.prototype.addMenuItem = function(menu, key, parent, trigger, sprite, label, checkmark)
{
