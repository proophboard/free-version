...
{
	if(this.graph.codySuggestEnabled && this.graph.codyUpCb) {
	...
	if(this.graph.codySuggestEnabled && this.graph.codyRightCb) {
	...
	if(this.graph.codySuggestEnabled && this.graph.codyDownCb) {
	...
	if(this.graph.codySuggestEnabled && this.graph.codyLeftCb) {
