...
HoverIcons.prototype.repaint = function()
{
	...
	if (this.currentState != null)
	{
			...
			this.graph.isCellConnectable(this.currentState.cell))
		{
			...
			this.arrowUp.style.left = Math.round(centerPoint.x - this.triangleUp.width / HoverIcons.prototype.pr / 2 - this.tolerance) + 'px';
			...
			this.arrowRight.style.top = Math.round(centerPoint.y - this.triangleRight.height / HoverIcons.prototype.pr / 2 - this.tolerance) + 'px';
